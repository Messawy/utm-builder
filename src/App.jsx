...
export default function App() {
  ...
  var saveH = function(){
    if(!utmUrl)return;
    var e = {url:utmUrl,campaign:campName,adset:asFull,ad:adFull,ts:new Date().toLocaleString(),id:Date.now()};
    ...
    <div style={{fontFamily:"'IBM Plex Sans',sans-serif",maxWidth:880,margin:"0 auto",padding:"16px 12px",color:"#1f2937"}}>
      ...
      {tab==="builder" && <div>
        ...
        {campName && <div style={{background:"#f8fafc",borderRadius:11,padding:13,border:"1px solid #e2e8f0"}}>
          ...
          <CopyBlock label="Full UTM URL" value={utmUrl} accent="#34d399" mono={true} onCopy={saveH}/>
